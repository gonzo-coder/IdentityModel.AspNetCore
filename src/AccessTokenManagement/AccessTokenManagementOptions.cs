...
namespace IdentityModel.AspNetCore.AccessTokenManagement
{
  ...
  public class AccessTokenManagementOptions
  {
    ...
    public class PasswordOptions
    {
      ...
      /// Used to prefix the cache key
      /// </summary>
      public string CacheKeyPrefix { get; set; } = "IdentityModel.AspNetCore.PasswordTokenManagement:";

      /// <summary>
      /// Configures named client configurations for requesting password tokens.
      /// </summary>
